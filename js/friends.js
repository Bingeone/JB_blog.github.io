...
$(function () { //获取处理友链数据
    $.getJSON("../json_data/friends.json", function (data) {
        ...
        $('.links-content').append("<div class='friend-title-item'><br><i>大佬们</i><br><hr></div>");
        $.each(data, function (i, e) {
            var html = "<div class=\"friend-card-item\">";
            if (e.src == undefined) {
                html += "    <img class=\"ava\" src=\"/img/src/un_link.png\" title=\"图片链接异常\">";
            } else {
                html += "    <img class=\"ava\" src=\"" + e.src + "\">";
            }
            html +=
                "<div class='text-desc' title=\""+e.desc+"\">    博客：<a href=\"" + e.url + "\" target=\"_blank\">" + e.name + "</a>" +
                "    <br>时间：" + e.time +
                "<br>简述：" + e.desc + "</div>" +
                "    </div>";
        ...
        if (notValid.length > 0) {
            $('.links-content').append("<div class='friend-title-item'><br><i>异常的大佬们<i><br><hr></div></div>");
